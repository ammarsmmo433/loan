				...
				<table class="table table-bordered" id="loan-list">
					...
					<tbody>
						<?php
							...
							$qry = $conn->query("SELECT l.*,concat(b.lastname,', ',b.firstname,' ',b.middlename)as name, b.contact_no, b.address from loan_list l inner join borrowers b on b.id = l.borrower_id and b.id = $_SESSION[userlogin_id]  order by id asc");
