	...
	<form action="" id="loan-application">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<?php
				$borrower = $conn->query("SELECT *,concat(lastname,', ',firstname,' ',middlename) as name FROM borrowers where id= $_SESSION[userlogin_id] order by concat(lastname,', ',firstname,' ',middlename) asc ");
				?>
